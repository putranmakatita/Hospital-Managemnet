...
Object[][] formStructure = {
    ...
    {"Manufacturer", "TextField", null, null},
    {"Expiration_Date", "DateField", null, null},
    {"Dosage", "TextField", null, null},
    {"Stock", "IntegerField", null, null},
    {"Status", "ComboBox", new String[]{"Available", "Out of Stock"}, null}
};

        PageHeader pageHeader = new PageHeader("Medicine", formStructure, "/reports/MedicinesReport.jrxml");
         final String[] MEDICINES_COLUMNS = {
        "ID", "Name", "Manufacturer", "Expiration Date", "Dosage", "Stock", "Status", "Action"
    };
        Table tablePanel = new Table(MEDICINES_COLUMNS, "medicines", formStructure);
        pageHeader.setTable(tablePanel, "medicines");
