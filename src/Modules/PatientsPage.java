...
Object[][] formStructure = {
    ...
    {"Status", "ComboBox", new String[]{"Active", "Inactive"}, null}
        ...
        PageHeader pageHeader = new PageHeader("Patient", formStructure, "/reports/PatientsReport.jrxml");
            
     final String[] PATIENTS_COLUMNS = {
        "ID", "Name", "Date of Birth", "Gender", "Phone Number", "Email", "Address", "Diagnosis", "Treatment Status", "Status", "Action"
    };

        Table tablePanel = new Table(PATIENTS_COLUMNS, "patients", formStructure);
        pageHeader.setTable(tablePanel, "patients");
